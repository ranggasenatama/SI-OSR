...
namespace SIOSR.Controllers
{
    public class PembelianController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UmkmId,Title,Price,Name,Phone,Email,Address,Amount,AccountNumber,Shipping")] Pembelian pembelian)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UmkmId,Title,Price,Name,Phone,Email,Address,Amount,AccountNumber,Shipping")] Pembelian pembelian)
        {
            if (id != pembelian.Id)
            {
                return NotFound();
