...
namespace SIOSR.Controllers
{
    public class UmkmController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Title,Type,Price,Description,Image,Status,Id")] Umkm umkm)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Title,Type,Price,Description,Image,Status,Id")] Umkm umkm)
        {
            if (id != umkm.Id)
            {
                return NotFound();
